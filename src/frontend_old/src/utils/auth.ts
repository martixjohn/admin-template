...
export const removeCsrfToken = () => localStorage.removeItem(CSRF_TOKEN_KEY);
...
export const getCurrentUser = () =>
  storageLocal().getItem<DataInfo<number>>(USER_INFO_KEY);

export const getCurrentRoles = () =>
  storageLocal().getItem<DataInfo<number>>(USER_INFO_KEY)?.roles ?? [];
