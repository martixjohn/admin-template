...
/** 管理员删除用户 DELETE /user/delete */
export async function deleteUser(options?: { [key: string]: any }) {
  return request<API.ApiResponseVoid>("/user/delete", {
    method: "DELETE",
    ...(options || {}),
  });
}

/** 此处后端没有提供注释 POST /user/get-batch */
export async function getBatch(body: API.PageQueryRequest, options?: { [key: string]: any }) {
  return request<API.ApiPageResponseUserSafeVO>("/user/get-batch", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
