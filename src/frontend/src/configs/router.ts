...
import { Role } from "@/configs/auth.ts";
...
export const enum Route {
  ...
  // 运行监控
  RUNTIME_MONITOR = "/system/runtime-info",
...
export const routerConfig: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        name: Route.RUNTIME_MONITOR,
        path: Route.RUNTIME_MONITOR,
        component: () => import("@/views/dashboard/main/system/runtimemonitor/RuntimeMonitorView.vue"),
      },
      {
